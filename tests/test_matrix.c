...
{
	double	same[MAT_MAX][MAT_MAX] = {
		{1, 2, 3, 4},
		{5, 6, 7, 8},
		{9, 8, 7, 6},
		{5, 4, 3, 2}
	};
	double	diff[MAT_MAX][MAT_MAX] = {
		{2, 3, 4, 5},
		{6, 7, 8, 9},
		{8, 7, 6, 5},
		{4, 3, 2, 1}
...
{
	double	yes[MAT_MAX][MAT_MAX] = {
		{6, 4, 4, 4},
		{5, 5, 7, 6},
		{4, -9, 3, -7},
		{9, 1, 7, -6}
	};
	double	no[MAT_MAX][MAT_MAX] = {
		{-4, 2, -2, -3},
		{9, 6, 2, 6},
		{0, -5, 1, -5},
		{0, 0, 0, 0}
...
{
	double	auxa[MAT_MAX][MAT_MAX] = {
		{ 3, -9, 7, 3 },
		{ 3, -8, 2, -9 },
		{ -4, 4, 4, 1 },
		{ -6, 5, -1, 1 },
	};
	double	auxb[MAT_MAX][MAT_MAX] = {
		{ 8, 2, 2, 2 },
		{ 3, -1, 7, 0 },
		{ 7, 0, 5, 4 },
		{ 6, -2, 0, 5 }

...
/*   Updated: 2022/11/03 19:55:00 by maolivei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	test_view_transformation(void)
{
	...
	// RUN_TEST(test_transformation_moves_the_world); /* obsolete, read above */
	// RUN_TEST(test_arbitrary_view_transformation); /* obsolete, read above */
}
